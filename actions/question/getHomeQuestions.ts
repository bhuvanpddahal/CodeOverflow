...
import {
    GetHomeQuestionsPayload,
    GetHomeQuestionsValidator
} from "@/lib/validators/question";

export const getHomeQuestions = async (payload: GetHomeQuestionsPayload) => {
    try {
        const validatedFields = GetHomeQuestionsValidator.safeParse(payload);
